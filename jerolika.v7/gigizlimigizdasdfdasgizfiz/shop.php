...
<?php if($_GET['cp_update_shopID']){
	...
	<tr><td>&nbsp;</td><td colspan="2"><input type="submit" name="cp_shop_update" value="Update">&nbsp;<input type="submit" name="cp_shop_delete" value="Delete"></td></tr>
...
<?php if($_GET['cp_add_shopID']){?>
	...
	<tr><td>Item Image:</td><td colspan="2"><input type="text" name="cp_shop_Image" value="<?php echo $cp_shop_Image;?>"></td></tr>
	<tr><td>&nbsp;</td><td colspan="2"><input type="submit" name="cp_shop_update" value="Update">&nbsp;<input type="reset" name="reset" value="Reset"></td></tr>
