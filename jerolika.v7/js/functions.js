...
function setGender(genderID, mybase, mymouth, myeyes, myhair, myaccessories, mytops, mybeard, mybottoms, myshoes)
{
	...
	document.getElementById('itemWin').innerHTML  = '<span class="notice">Suanda Esya Ve Kiyafet Cantani Actin.Buradan Kiyafet Ve Esyalarini Giyebilirsin ;) (Ekran Kararmasi Oluyorsa Mozilla Firefoxtan Giriniz)<br><br>Hic Kiyafet Veya Esyan Yok Mu ? - <a href="../shop/index.php" target="_blank">O Zaman Hemen ReadLika Markete Git ;)</a></span>';
}
...
function saveAvatar()
{
	if(guestUser)
	{
		document.getElementById('itemWin').innerHTML  = '<span class="notice" style="color:#48AFFF">Oops, you need to be logged in to save your avatar!<br><br>Not a member? - <a href="../index.php">Register FREE Now!</a></span>';
		return false;
	}
