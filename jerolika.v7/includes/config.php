...
$CONFIG['admin_name'] = '83rk444123yyg3'; // admin username
$CONFIG['admin_pass'] = '111213131123123jnb'; // admin password
$CONFIG['mods_name'] = '41stix41'; // moderators username
$CONFIG['mods_pass'] = 'editorrrrggggiiiiris'; // moderators password
...
$CONFIG['credits_free_signup'] = '6000'; // free credits on signup
$CONFIG['credits_free_login_min'] = '1000'; // free credits per daily login (min)
$CONFIG['credits_free_login_max'] = '1000'; // free credits per daily login (max)

// Reward Credits
// these are free credits awarded for user actions

$CONFIG['reward_profile'] = '3'; // credits (each profile viewed)
$CONFIG['reward_heart'] = '200'; // credits (each heart sent)
...
$CONFIG['allow_guests'] = '0'; // allow guests to login - 0 No, 1 Yes
